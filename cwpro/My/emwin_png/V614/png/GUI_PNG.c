...
*    Returns the X-size of a specified PNG image, which does not have to be
*    loaded into memory.
*
*  Parameters
*    pfGetData: Pointer to a function which is called for getting data. For details about
*               the GetData function, refer to \ref{Getting data with the ...Ex() functions}.
...
*
*  Function description
*    Returns the Y-size of a specified PNG image, which does not have to be
*    loaded into memory.
*
*  Parameters
*    pfGetData: Pointer to a function which is called for getting data. For details about
...
*
*  Function description
*    Draws a png file, which does not have to be loaded into memory, at a specified
...
*
*  Additional information
*    The Sample folder contains the example \c{2DGL_DrawPNG.c} which shows how to use the
*    function.
*/
